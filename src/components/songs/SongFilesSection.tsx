...
import { FileUploadDropzone, FileTypeIcon, FileUploadDropzoneRef } from "./FileUploadDropzone";
...
export function SongFilesSection({ songId }: SongFilesSectionProps) {
  ...
  const handleDelete = async (fileId: Id<"songFiles">) => {
    try {
            ...
            {files.map((file) => (
              ...
              >
                ...
                <div className="flex items-center gap-1">
                  ...
                  {file.url && (
                    <>
                      {file.fileType === "audio" && file.storageId && (
                        <Button
                          variant="ghost"
                          size="icon"
                          asChild
